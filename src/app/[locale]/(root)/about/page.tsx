...
const AboutPage = () => {
    ...
    return (
        <section id='about-me' className='container mx-auto px-4 py-8 text-justify'>

            <div className="bg-gray-100 p-6 rounded-lg shadow-lg shadow-black mb-8">
            ...
            <div className='grid grid-cols-1 md:grid-cols-[auto_1fr] gap-8 mb-8'>
                <div className='bg-gray-100 p-6 rounded-lg shadow-lg shadow-black'>
